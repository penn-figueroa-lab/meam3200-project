...
%% ================== SYSTEM PARAMETERS ==================
global K L I_total b_bearing g motor_weight lever2motor imuss_weight lever2imuss
...
lever_density = 600;
lever_weight  = prod(lever_size) * lever_density;
motor_weight  = 0.0145;
imuss_weight  = 0.002;

I_lever = lever_weight * (lever_size(1)^2 + lever_size(2)^2) / 12;
I_motor = motor_weight * (lever2motor(1)^2 + lever2motor(2)^2);
I_imuss = imuss_weight * (lever2imuss(1)^2 + lever2imuss(2)^2);
